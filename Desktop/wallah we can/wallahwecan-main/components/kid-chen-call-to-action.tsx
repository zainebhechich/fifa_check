...
import { LeafyGreen, Utensils, Handshake, ArrowRight, Zap } from "lucide-react"
    ...
    <div className="py-8 md:py-10">
      ...
      <div className="text-center mb-8">
        ...
        >
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-300 via-[#142346] to-orange-600 mb-3 drop-shadow-sm">
              {t("title")}
            </h2>
            <div className="mx-auto h-0.5 w-16 rounded-full bg-gradient-to-r from-[#142346] to-orange-500" />
          </div>
          <p className="mt-4 text-sm text-white/90 max-w-2xl mx-auto leading-relaxed">
            {t("subtitle")}
          </p>
        </motion.div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
          <Card className="bg-white/80 backdrop-blur-md shadow-md rounded-xl hover:shadow-lg transition-all duration-200 group">
            <CardContent className="p-6 text-center">
              <div className="flex flex-col items-center gap-3">
                ...
                <LeafyGreen aria-hidden="true" className="h-8 w-8 text-[#142346] group-hover:scale-110 transition-transform duration-200" />
                <div>
          ...
          <Card className="bg-white/80 backdrop-blur-md shadow-md rounded-xl hover:shadow-lg transition-all duration-200 group">
            <CardContent className="p-6 text-center">
              <div className="flex flex-col items-center gap-3">
                {/* PHASE 1 i18n fix: decorative icon */}
                <Utensils aria-hidden="true" className="h-8 w-8 text-[#142346] group-hover:scale-110 transition-transform duration-200" />
                <div>
          ...
          <Card className="bg-white/80 backdrop-blur-md shadow-md rounded-xl hover:shadow-lg transition-all duration-200 group">
            <CardContent className="p-6 text-center">
              <div className="flex flex-col items-center gap-3">
                {/* PHASE 1 i18n fix: decorative icon */}
                <Handshake aria-hidden="true" className="h-8 w-8 text-[#142346] group-hover:scale-110 transition-transform duration-200" />
                <div>
      ...
      >
        <Link href={`/${locale}/faire-un-don`} className="w-full sm:w-auto">
          {/* PHASE 1 i18n fix: add accessible label from translations */}
          <button aria-label={t("donate")} className="w-full bg-[#142346] hover:bg-[#142346]/90 text-white shadow-lg transition-all duration-200 hover:shadow-xl group relative overflow-hidden rounded-lg px-6 py-3 font-medium">
            ...
            <div className="relative flex items-center justify-center gap-2">
              <Utensils aria-hidden="true" className="h-4 w-4 group-hover:scale-110 transition-transform" />
              <span>{t("donate")}</span>
