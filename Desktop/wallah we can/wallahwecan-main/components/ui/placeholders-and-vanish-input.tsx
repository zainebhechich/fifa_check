...
export function PlaceholdersAndVanishInput({
  ...
  return (
    ...
    >
      <canvas
        className={cn(
          "absolute left-2 top-[20%] pointer-events-none origin-top-left scale-50 transform filter invert dark:invert-0 sm:left-8 pr-20 text-base",
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="w-[calc(100%-2rem)] truncate pl-4 text-left font-normal text-neutral-500 dark:text-zinc-500 sm:pl-12 sm:text-base text-sm"
            >
