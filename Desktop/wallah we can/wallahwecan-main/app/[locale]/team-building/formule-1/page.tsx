...
export default function Formule1Page() {
  const t = useTranslations("TeamBuilding.Formulas.Formule1");
  const bgStyle = {
      ...
      <main className="relative pt-24 pb-6">
        ...
        <div className="relative z-10">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            >
              <div className="inline-block bg-orange-500/10 text-orange-600 px-3 py-1 rounded-full text-sm font-medium mb-4">
                {t("badge")}
              </div>
