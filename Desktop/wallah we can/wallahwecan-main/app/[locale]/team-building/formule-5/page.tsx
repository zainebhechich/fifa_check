...
import { Settings, Users, Clock, MapPin } from "lucide-react";
import { Button } from "../../../../components/ui/button";
import { useTranslations } from "next-intl";

const benefitsOrder = ["affordable", "impact", "partnership"] as const;

export default function Formule5Page() {
  const t = useTranslations("TeamBuilding.Formulas.Formule5");
  const bgStyle = {
      ...
      <main className="relative pt-24 pb-6">
        ...
        <div className="relative z-10">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            >
              <div className="inline-block bg-gray-500/10 text-gray-600 px-3 py-1 rounded-full text-sm font-medium mb-4">
                {t("badge")}
              </div>
